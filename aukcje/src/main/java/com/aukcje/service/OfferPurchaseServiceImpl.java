...
public class OfferPurchaseServiceImpl implements OfferPurchaseService {
    ...
    @Override
    public void purchaseItems(List<OfferPurchaseModel> offerPurchaseModels, Long buyerId) {
        ...
        for(OfferPurchaseModel offerPurchaseModel: offerPurchaseModels){
            ...
            User seller = userRepository.findById(offer != null ? offer.getUser().getId() : null).orElse(null);
